...
public class Alerts {
  public static final String LOGIN_ALERT_TEXT = "You logged into a secure area!";
  ...
  public static String USER_TAKEN_ALERT_TEXT = "Username is already taken.";
  ...
  public static String USER_PROFILE_UPDATED_MESSAGE = "Profile updated successful";
  ...
  public static String PASSWORD_LENGTH_MESSAGE = "New password must be between 6 and 30 characters";
  public static String SAME_PASSWORD_MESSAGE = "The new password should be different from the current password";
